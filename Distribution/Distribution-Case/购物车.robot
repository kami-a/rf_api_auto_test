...
购物车添加删除
    ...
    ${uid}    设置变量    ${resp0.json()['result']['uid']}
    #获取添加购物车商品信息
...
购物车选中取消选中
    ...
    ${resp2}    购物车列表    ${token}
    接口调用是否成功    ${resp2}
    ${skuId2}    设置变量    ${resp2.json()['result']['shops'][0]['products'][0]['skuId']}
    ${checked2}    设置变量    ${resp2.json()['result']['shops'][0]['products'][0]['checked']}
    #取消选中商品
    ...
    ${resp4}    购物车列表    ${token}
    接口调用是否成功    ${resp4}
    ${checked4}    设置变量    ${resp4.json()['result']['shops'][0]['products'][0]['checked']}
